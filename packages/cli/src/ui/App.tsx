    ...
    const flashFallbackHandler = async (
      ...
      if (
        ...
        if (error && isProQuotaExceededError(error)) {
          if (isPaidTier) {
            message = `⚡ You have reached your daily ${currentModel} quota limit. Automatically switching to ${fallbackModel} for the remainder of this session.`;
          } else {
            message = `⚡ You have reached your daily ${currentModel} quota limit. Automatically switching to ${fallbackModel} for the remainder of this session.`;
          }
        } else if (error && isGenericQuotaExceededError(error)) {
          if (isPaidTier) {
            message = `⚡ You have reached your daily quota limit. Automatically switching to ${fallbackModel} for the remainder of this session.`;
          } else {
            message = `⚡ You have reached your daily quota limit. Automatically switching to ${fallbackModel} for the remainder of this session.`;
          }
        } else {
          if (isPaidTier) {
            ...
            message = `⚡ Automatically switching to ${fallbackModel} for faster responses for the remainder of this session.`;
          } else {
            // Default fallback message for other cases (like consecutive 429s)
            message = `⚡ Automatically switching to ${fallbackModel} for faster responses for the remainder of this session.`;
          }
