...
This page contains tutorials for interacting with G-PROJECT.
...
G-PROJECT uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch G-PROJECT and verify the connection

When you launch G-PROJECT, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask G-PROJECT to perform GitHub actions. For example:
