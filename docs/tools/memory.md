...
This document describes the `save_memory` tool for the G-PROJECT.

## Description

Use `save_memory` to save and recall information across your G-PROJECT sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
## How to use `save_memory` with the G-PROJECT
...
```
save_memory(fact="The project I'm currently working on is called 'g-project'.")
```
